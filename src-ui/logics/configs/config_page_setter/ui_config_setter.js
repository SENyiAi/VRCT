...
export const SETTINGS_ARRAY = [
    ...
    {
        Category: "Translation",
        Base_Name: "SiliconFlowAsrCorrection",
        default_value: false,
        ui_template_id: "toggle",
        logics_template_id: "toggle_enable_disable",
        base_endpoint_name: "siliconflow_asr_correction",
    },
    {
        Category: "Translation",
        Base_Name: "SiliconFlowEnableThinking",
        default_value: false,
        ui_template_id: "toggle",
        logics_template_id: "toggle_enable_disable",
        base_endpoint_name: "siliconflow_enable_thinking",
    },
    {
        Category: "Translation",
        Base_Name: "SiliconFlowMaxTokens",
        default_value: 1024,
        ui_template_id: "input",
        logics_template_id: "get_set",
        base_endpoint_name: "siliconflow_max_tokens",
    },
    {
        Category: "Translation",
        Base_Name: "SiliconFlowTemperature",
        default_value: 0.4,
        ui_template_id: "input",
        logics_template_id: "get_set",
        base_endpoint_name: "siliconflow_temperature",
    },
    {
        Category: "Translation",
        Base_Name: "SiliconFlowCustomSystemPrompt",
        default_value: "",
        ui_template_id: "input",
        logics_template_id: "get_set",
        base_endpoint_name: "siliconflow_custom_system_prompt",
    },
    // LM Studio
    {
        Category: "Translation",
