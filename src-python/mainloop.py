...
mapping = {
    ...
    "/get/data/custom_openai_url": {"status": True, "variable":controller.getCustomOpenAIURL},
    "/set/data/custom_openai_url": {"status": True, "variable":controller.setCustomOpenAIURL},
    "/get/data/custom_openai_auth_key": {"status": True, "variable":controller.getCustomOpenAIAuthKey},
    "/set/data/custom_openai_auth_key": {"status": True, "variable":controller.setCustomOpenAIAuthKey},
    "/delete/data/custom_openai_auth_key": {"status": True, "variable":controller.delCustomOpenAIAuthKey},
    "/get/data/custom_openai_model": {"status": True, "variable":controller.getCustomOpenAIModel},
    "/set/data/custom_openai_model": {"status": True, "variable":controller.setCustomOpenAIModel},
    "/get/data/connected_custom_openai": {"status": True, "variable":controller.getCustomOpenAIConnection},
    "/run/custom_openai_connection": {"status": True, "variable":controller.checkCustomOpenAIConnection},
    "/get/data/custom_openai_asr_correction": {"status": True, "variable":controller.getCustomOpenAIAsrCorrection},
    "/set/enable/custom_openai_asr_correction": {"status": True, "variable":controller.setEnableCustomOpenAIAsrCorrection},
    "/set/disable/custom_openai_asr_correction": {"status": True, "variable":controller.setDisableCustomOpenAIAsrCorrection},
    "/run/test_custom_openai_translation": {"status": True, "variable":controller.testCustomOpenAITranslation},
    "/get/data/custom_openai_max_tokens": {"status": True, "variable":controller.getCustomOpenAIMaxTokens},
    "/set/data/custom_openai_max_tokens": {"status": True, "variable":controller.setCustomOpenAIMaxTokens},
    "/get/data/custom_openai_temperature": {"status": True, "variable":controller.getCustomOpenAITemperature},
    "/set/data/custom_openai_temperature": {"status": True, "variable":controller.setCustomOpenAITemperature},
    "/get/data/custom_openai_custom_system_prompt": {"status": True, "variable":controller.getCustomOpenAICustomSystemPrompt},
    "/set/data/custom_openai_custom_system_prompt": {"status": True, "variable":controller.setCustomOpenAICustomSystemPrompt},

    # Custom OpenAI 2
    "/get/data/custom_openai_2_url": {"status": True, "variable":controller.getCustomOpenAI2URL},
    "/set/data/custom_openai_2_url": {"status": True, "variable":controller.setCustomOpenAI2URL},
    "/get/data/custom_openai_2_auth_key": {"status": True, "variable":controller.getCustomOpenAI2AuthKey},
    "/set/data/custom_openai_2_auth_key": {"status": True, "variable":controller.setCustomOpenAI2AuthKey},
    "/delete/data/custom_openai_2_auth_key": {"status": True, "variable":controller.delCustomOpenAI2AuthKey},
    "/get/data/custom_openai_2_model": {"status": True, "variable":controller.getCustomOpenAI2Model},
    "/set/data/custom_openai_2_model": {"status": True, "variable":controller.setCustomOpenAI2Model},
    "/get/data/connected_custom_openai_2": {"status": True, "variable":controller.getCustomOpenAI2Connection},
    "/run/custom_openai_2_connection": {"status": True, "variable":controller.checkCustomOpenAI2Connection},
    "/get/data/custom_openai_2_asr_correction": {"status": True, "variable":controller.getCustomOpenAI2AsrCorrection},
    "/set/enable/custom_openai_2_asr_correction": {"status": True, "variable":controller.setEnableCustomOpenAI2AsrCorrection},
    "/set/disable/custom_openai_2_asr_correction": {"status": True, "variable":controller.setDisableCustomOpenAI2AsrCorrection},
    "/run/test_custom_openai_2_translation": {"status": True, "variable":controller.testCustomOpenAI2Translation},
    "/get/data/custom_openai_2_max_tokens": {"status": True, "variable":controller.getCustomOpenAI2MaxTokens},
    "/set/data/custom_openai_2_max_tokens": {"status": True, "variable":controller.setCustomOpenAI2MaxTokens},
    "/get/data/custom_openai_2_temperature": {"status": True, "variable":controller.getCustomOpenAI2Temperature},
    "/set/data/custom_openai_2_temperature": {"status": True, "variable":controller.setCustomOpenAI2Temperature},
    "/get/data/custom_openai_2_custom_system_prompt": {"status": True, "variable":controller.getCustomOpenAI2CustomSystemPrompt},
    "/set/data/custom_openai_2_custom_system_prompt": {"status": True, "variable":controller.setCustomOpenAI2CustomSystemPrompt},

    # Custom OpenAI 3
    "/get/data/custom_openai_3_url": {"status": True, "variable":controller.getCustomOpenAI3URL},
    "/set/data/custom_openai_3_url": {"status": True, "variable":controller.setCustomOpenAI3URL},
    "/get/data/custom_openai_3_auth_key": {"status": True, "variable":controller.getCustomOpenAI3AuthKey},
    "/set/data/custom_openai_3_auth_key": {"status": True, "variable":controller.setCustomOpenAI3AuthKey},
    "/delete/data/custom_openai_3_auth_key": {"status": True, "variable":controller.delCustomOpenAI3AuthKey},
    "/get/data/custom_openai_3_model": {"status": True, "variable":controller.getCustomOpenAI3Model},
    "/set/data/custom_openai_3_model": {"status": True, "variable":controller.setCustomOpenAI3Model},
    "/get/data/connected_custom_openai_3": {"status": True, "variable":controller.getCustomOpenAI3Connection},
    "/run/custom_openai_3_connection": {"status": True, "variable":controller.checkCustomOpenAI3Connection},
    "/get/data/custom_openai_3_asr_correction": {"status": True, "variable":controller.getCustomOpenAI3AsrCorrection},
    "/set/enable/custom_openai_3_asr_correction": {"status": True, "variable":controller.setEnableCustomOpenAI3AsrCorrection},
    "/set/disable/custom_openai_3_asr_correction": {"status": True, "variable":controller.setDisableCustomOpenAI3AsrCorrection},
    "/run/test_custom_openai_3_translation": {"status": True, "variable":controller.testCustomOpenAI3Translation},
    "/get/data/custom_openai_3_max_tokens": {"status": True, "variable":controller.getCustomOpenAI3MaxTokens},
    "/set/data/custom_openai_3_max_tokens": {"status": True, "variable":controller.setCustomOpenAI3MaxTokens},
    "/get/data/custom_openai_3_temperature": {"status": True, "variable":controller.getCustomOpenAI3Temperature},
    "/set/data/custom_openai_3_temperature": {"status": True, "variable":controller.setCustomOpenAI3Temperature},
    "/get/data/custom_openai_3_custom_system_prompt": {"status": True, "variable":controller.getCustomOpenAI3CustomSystemPrompt},
    "/set/data/custom_openai_3_custom_system_prompt": {"status": True, "variable":controller.setCustomOpenAI3CustomSystemPrompt},

    # Fallback
    "/get/data/translation_fallback_enabled": {"status": True, "variable":controller.getTranslationFallbackEnabled},
    "/set/enable/translation_fallback_enabled": {"status": True, "variable":controller.setEnableTranslationFallback},
    "/set/disable/translation_fallback_enabled": {"status": True, "variable":controller.setDisableTranslationFallback},
    "/get/data/translation_fallback_timeout": {"status": True, "variable":controller.getTranslationFallbackTimeout},
    "/set/data/translation_fallback_timeout": {"status": True, "variable":controller.setTranslationFallbackTimeout},
    ...
    "/get/data/siliconflow_asr_correction": {"status": True, "variable":controller.getSiliconFlowAsrCorrection},
    "/set/enable/siliconflow_asr_correction": {"status": True, "variable":controller.setEnableSiliconFlowAsrCorrection},
    "/set/disable/siliconflow_asr_correction": {"status": True, "variable":controller.setDisableSiliconFlowAsrCorrection},
    "/get/data/siliconflow_enable_thinking": {"status": True, "variable":controller.getSiliconFlowEnableThinking},
    "/set/enable/siliconflow_enable_thinking": {"status": True, "variable":controller.setEnableSiliconFlowEnableThinking},
    "/set/disable/siliconflow_enable_thinking": {"status": True, "variable":controller.setDisableSiliconFlowEnableThinking},
    "/get/data/siliconflow_max_tokens": {"status": True, "variable":controller.getSiliconFlowMaxTokens},
    "/set/data/siliconflow_max_tokens": {"status": True, "variable":controller.setSiliconFlowMaxTokens},
    "/get/data/siliconflow_temperature": {"status": True, "variable":controller.getSiliconFlowTemperature},
